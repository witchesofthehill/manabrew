...
/** Cards inside modal grids (e.g., ChooseCardsModal, SpellStackModal, ZoneTargetSelector) */
...
/** Selectable card tiles in ChooseCardsModal (phone / larger). */
export const CHOOSE_CARD_TILE_SIZE = "w-[94px] sm:w-[150px]" as const;
/** Prompt-modal source card image, vertical / horizontal layout, with the
 *  compact (mobile game) variants. */
