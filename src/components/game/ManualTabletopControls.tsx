...
export function ManualTabletopControls({ gameView, api }: ManualTabletopControlsProps) {
  ...
  return (
    <div className="absolute right-[calc(0.5rem+env(safe-area-inset-right))] bottom-[calc(0.5rem+env(safe-area-inset-bottom))] z-30 w-[320px] max-h-[60%] overflow-y-auto rounded-md border bg-background/95 shadow-sm backdrop-blur">
