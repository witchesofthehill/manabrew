...
pub enum SessionFrame {
    ...
    Hello {
        ...
        /// Highest `seq` this seat has already applied. Zero on a fresh session.
        /// Unused in phase 1, where a lost channel recovers through the relay's
        /// existing `RequestResync` instead of a barrier handshake.
        #[serde(default)]
        resume_from: u64,
    },
    Welcome {
