...
description: Where to find what changed and what's coming.
---
...
Direction is tracked in the open:

- [Open issues](https://github.com/witchesofthehill/manabrew/issues) — bugs
  and planned work.
- [Pull requests](https://github.com/witchesofthehill/manabrew/pulls) —
