...
pub struct ChooseBooleanInput {
    ...
    // the engine's own tag for the question, e.g. Forge's PlayerActionConfirmMode,
    // BinaryChoiceType or cost part class
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
    pub detail: Option<String>,
    // the engine's effect category (Forge ApiType) of the ability being confirmed
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
